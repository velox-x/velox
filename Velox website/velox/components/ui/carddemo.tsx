...
// Separate the animated content into its own client component
...
export function CardDemo() {
  return (
    <Card>
      ...
      <CardTitle>1 SOL (Lifetime)</CardTitle>
      <CardDescription>
        <Button
          size="default"
          className="text-white bg-white/5 hover:bg-white/10 border text-lg px-5 py-2.5 h-auto"
        >
          Purchase Now
        </Button>
      </CardDescription>
...
const Skeleton = () => {
  ...
  // Properly type the animation sequence
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        ...
        <Container className="h-12 w-12 circle-2">
          <FaEthereum className="h-6 w-6 dark:text-white" />
        </Container>
        <Container className="circle-3">
          <SiSolana className="h-8 w-8 dark:text-white" />
        </Container>
        <Container className="h-12 w-12 circle-4">
          <RiXrpFill className="h-6 w-6" />
        </Container>
        <Container className="h-8 w-8 circle-5">
          <SiDogecoin className="h-4 w-4" />
        </Container>
      </div>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.30)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
